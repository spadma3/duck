...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yunfantang/duckietown/catkin_ws/install_isolated/${idir}'.  Ask the maintainer 'Aaron Walsman <awalsman@andrew.cmu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yunfantang/duckietown/catkin_ws/install_isolated/lib;/home/yunfantang/duckietown/catkin_ws/devel_isolated/adafruit_drivers/lib;/home/yunfantang/duckietown/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
