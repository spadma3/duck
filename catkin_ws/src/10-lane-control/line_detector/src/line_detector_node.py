...
class LineDetectorNode(object):
    def __init__(self):
        ...
        # Subscribers
        self.sub_image = rospy.Subscriber("~image/compressed", CompressedImage, self.cbImage, queue_size=1)
        self.sub_image_black = rospy.Subscriber("~image/black_background", CompressedImage, self.cbImage, queue_size=1)
