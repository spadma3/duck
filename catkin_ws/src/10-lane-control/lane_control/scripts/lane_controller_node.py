...
class lane_controller(object):
    ...
    def __init__(self):
        ...
        #TODO JULIEN EDITED bool to BoolStamped
        #self.subscriber = rospy.Subscriber(self.sub_topic, BoolStamped, self.obstacleFlagCallback)

        #TODO OOOOH MAN
        #self.sub_topic = '/{}/obst_avoid/d_target'.format(robot_name)
        #self.subscriber = rospy.Subscriber(self.sub_topic, np.float32,
        #                                   self.obstAvoidDUpdate)  # Absolute value, with 0 on center line

        #self.sub_topic = '/obstacle_emergency_stop_flag'.format(robot_name)
        #TODO JULIEN EDITED bool to BoolStamped
        #self.subscriber = rospy.Subscriber(self.sub_topic, BoolStamped, self.obstEmergBrakeUpdate)
