...
# ---- end tag info stuff 
    ...
    def callback(self, msg):
        ...
        #print ("AprilTag Postprocessing Callback [Hz]: ", 1/(end-begin), "AprilTag Postprocessing Callback [s]: ", (end-begin))
        print ("AprilTag Postprocessing Callback [s]: ", (end.nsecs-begin.nsecs)/1000000000)
