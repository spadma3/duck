...
class ImgRectFullRatio(object):
    ...
    def cbImg(self,msg):
        ...
        # undistort the image
        # Origin ratio = 1.65, change to lower ratio to increase the speed of apriltags detection
        new_matrix, result_img = self.gpg.rectify_full(cv_image, ratio=1.65)  ## JZ: added cubic interpolation
