...
class vehicle_introducer_node():
	def __init__(self):
		try:
			pos_dist = np.load("~/duckietown/catkin_ws/src/vehicle_detection_tracking/ClassifierDistribution/posDist.npy").tolist()
			neg_dist = np.load("~/duckietown/catkin_ws/src/vehicle_detection_tracking/ClassifierDistribution/negDist.npy").tolist()
